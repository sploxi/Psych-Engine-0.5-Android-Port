...
class PlayState extends MusicBeatState
{
	...
	['you can improve', 0.2], //From 0% to 19%
		['Are you a 6 year old?', 0.4], //From 20% to 39%
		['Bad as hell', 0.5], //From 40% to 49%
		['shit', 0.6], //From 50% to 59%
		['that's ok', 0.69], //From 60% to 68%
		['ok', 0.7], //69%
		['Good', 0.8], //From 70% to 79%
		['nothing bad', 0.9], //From 80% to 89%
		['que pro', 1], //From 90% to 99%
		['OH MY GOD I FOUND A HACKER', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
